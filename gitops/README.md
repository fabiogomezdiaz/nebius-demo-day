...
| Workloads | `terraform/workloads` | `login.sh` |

Training files live in `workloads/` and are copied onto the jail with `./scripts/04-sync_workloads.sh`, then submitted with `sbatch`.
